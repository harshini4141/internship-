...
import heroImg from '../assets/images/kerala2.jpg'
import heroImg02 from '../assets/images/kerala.jpg'
...
const Home = () => {
  return (
    ...
    <section>
      <Container>
        ...
        <p>Travel takes us out of our comfort zones and inspires us to see, taste and try new things. 
          <br />
          It feels like you're on top of the world.</p>
    ...
    <section>
      <div class="marquee">
      <span>....The journey is never ending ☺️....</span>
      </div>
      </section>
